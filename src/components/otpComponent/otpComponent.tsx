...
>
  ...
  <DialogContent>
    ...
    <div className="flex flex-col justify-between">
      <div className="flex">
        <div className="text-xs font-medium">{data?.login?.userLoginId}</div>
    ...
    <OtpInput
      ...
      renderInput={(props) => (
        <input
          ...
          style={{
            ...otpBoxStyle,
            border: otp.length === 6 && /^\d{6}$/.test(otp) ? "1px solid #ccc" : "1px solid red",
          }}
        />
      )}
      value={otp}
  ...
  <DialogActions style={{ paddingBottom: "25px", paddingLeft: "4px", paddingRight: "4px" }}>
    <button
      className={`p-2 h-11 w-full text-sm flex justify-center items-center rounded-xl ${
        disableBtn ? "bg-gray-400 text-white" : "bg-menuHilight text-black"
      }`}
